...
<footer class="bg-white dark:bg-gray-800">
        ...
        <div class="md:flex md:justify-between">
            <div>
                <a href="https://flowbite.com/" class="flex items-center">
                    <img src="<?php echo e(url('images/logo.png')); ?>" class="h-24 mr-3" alt="Logo" />
                </a>
                <div class="max-w-sm">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">ZayratsShop</a>. All Rights Reserved.
        </span>
...
<?php /**PATH D:\ega\kuliah\workshop aplikasi berbasis web\Proyek_akhir\zayrats_shop\resources\views/partials/footer.blade.php ENDPATH**/ ?>