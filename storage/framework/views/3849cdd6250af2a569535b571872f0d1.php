...
$__html = app('livewire')->mount($__name, $__params, 'IrBDd7b', $__slots ?? [], get_defined_vars());
                    ...
                    <div class="row-span-1">
                        <div class="block p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="flex justify-between">
                                ...
                                <a href="<?php echo e(route('listUser')); ?>">
                    ...
                    <div class="row-span-1">
                        <div class="block p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="flex justify-between">
                                ...
                                <a href="<?php echo e(route('recentOrder')); ?>">
                                    <div class="w-2/2 py-2">
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-1">
                                            <svg class="w-6 h-6 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                            ...
                            <div class="flex justify-between">
                                ...
                                <a href="<?php echo e(route('orderAdmin')); ?>">
                                    <div class="w-2/2 py-2">
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-1">
                                            <svg class="w-6 h-6 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                            ...
                            <div class="flex justify-between">
                                ...
                                <a href="<?php echo e(route('createItem')); ?>">
                                    <div class="w-2/2 py-2">
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-1">
                                            <svg class="w-6 h-6 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                            ...
                            <div class="flex justify-between">
                                ...
                                <a href="<?php echo e(route('productPrice')); ?>">
                                    <div class="w-2/2 py-2">
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-1">
                                            <svg class="w-6 h-6 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                            ...
                            <div class="flex justify-between">
                                ...
                                <a href="<?php echo e(route('orderCheckout')); ?>">
                                    <div class="w-2/2 py-2">
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-1">
                                            <svg class="w-6 h-6 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
...
<?php /**PATH D:\ega\kuliah\workshop aplikasi berbasis web\Proyek_akhir\zayrats_shop\resources\views/admin/layouts/admin_order.blade.php ENDPATH**/ ?>